    ...
    */
    public com.bumptech.glide.request.target.ViewTarget<android.widget.ImageView, TranscodeType> into(android.widget.ImageView r4) {
        ...
        L27:
            goto L4c
        L28:
            com.bumptech.glide.request.BaseRequestOptions r0 = r3.mo192clone()
    ...
    private Request buildRequestRecursive(Target<TranscodeType> target, RequestListener<TranscodeType> requestListener, RequestCoordinator requestCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions, Priority priority, int i, int i2, BaseRequestOptions<?> baseRequestOptions, Executor executor) {
        ...
        Request requestBuildThumbnailRequestRecursive = requestBuilder.buildThumbnailRequestRecursive(target2, requestListener2, requestCoordinator2, transitionOptions2, priority2, i3, i4, baseRequestOptions2, executor2);
        ...
        errorRequestCoordinator2.setRequests(requestBuildThumbnailRequestRecursive, requestBuilder2.buildRequestRecursive(target, requestListener, errorRequestCoordinator2, requestBuilder2.transitionOptions, requestBuilder2.getPriority(), overrideWidth, overrideHeight, this.errorBuilder, executor));
    ...
    private Request buildThumbnailRequestRecursive(Target<TranscodeType> target, RequestListener<TranscodeType> requestListener, RequestCoordinator requestCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions, Priority priority, int i, int i2, BaseRequestOptions<?> baseRequestOptions, Executor executor) {
        ...
        if (requestBuilder != null) {
            ...
            Request requestBuildRequestRecursive = requestBuilder2.buildRequestRecursive(target, requestListener, thumbnailRequestCoordinator, transitionOptions2, priority2, overrideWidth, overrideHeight, requestBuilder2, executor);
        ...
        if (this.thumbSizeMultiplier != null) {
            ...
            thumbnailRequestCoordinator2.setRequests(obtainRequest(target, requestListener, baseRequestOptions, thumbnailRequestCoordinator2, transitionOptions, priority, i, i2, executor), obtainRequest(target, requestListener, baseRequestOptions.mo192clone().sizeMultiplier(this.thumbSizeMultiplier.floatValue()), thumbnailRequestCoordinator2, transitionOptions, getThumbnailPriority(priority), i, i2, executor));
