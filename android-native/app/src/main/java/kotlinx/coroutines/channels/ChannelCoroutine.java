...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2085receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2085receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2086tryReceivePtdJZtk() {
        return this._channel.mo2086tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2081trySendJP2dKIU(E element) {
        return this._channel.mo2081trySendJP2dKIU(element);
    }
