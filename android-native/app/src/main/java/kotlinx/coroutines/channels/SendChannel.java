...
public interface SendChannel<E> {
    ...
    Object mo2081trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2102isSuccessimpl(objMo2081trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2096exceptionOrNullimpl = ChannelResult.m2096exceptionOrNullimpl(objMo2081trySendJP2dKIU);
