...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM534constructorimpl2;
        ...
        try {
            ...
            objM534constructorimpl = Result.m534constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM534constructorimpl = Result.m534constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m537exceptionOrNullimpl(objM534constructorimpl) == null) {
            obj2 = objM534constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM534constructorimpl2 = Result.m534constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM534constructorimpl2 = Result.m534constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m537exceptionOrNullimpl(objM534constructorimpl2) == null) {
            obj = objM534constructorimpl2;
        }
