...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(Continuation<?> continuation) {
        ...
        try {
            ...
            objM534constructorimpl = Result.m534constructorimpl(continuation + TemplateDom.SEPARATOR + getHexAddress(continuation));
        } catch (Throwable th) {
        ...
        if (Result.m537exceptionOrNullimpl(objM534constructorimpl) != null) {
            objM534constructorimpl = continuation.getClass().getName() + TemplateDom.SEPARATOR + getHexAddress(continuation);
        }
        return (String) objM534constructorimpl;
    }
