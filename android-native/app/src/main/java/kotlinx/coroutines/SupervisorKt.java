...
public final class SupervisorKt {
    ...
    public static final /* synthetic */ Job m2076SupervisorJob(Job job) {
        return SupervisorJob(job);
    }

    /* renamed from: SupervisorJob$default, reason: collision with other method in class */
    public static /* synthetic */ Job m2077SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m2076SupervisorJob(job);
    }
