...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public Object invokeSuspend(Object result) {
        Throwable thM537exceptionOrNullimpl = Result.m537exceptionOrNullimpl(result);
        if (thM537exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM537exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.completion_;
