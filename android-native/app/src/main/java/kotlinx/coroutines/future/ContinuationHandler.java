...
final class ContinuationHandler<T> implements BiFunction<T, Throwable, Unit> {
    ...
    public void apply2(T result, Throwable exception) {
        ...
        if (exception == null) {
            ...
            continuation.resumeWith(Result.m534constructorimpl(result));
            return;
        }
        CompletionException completionExceptionM1875m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1880m((Object) exception) ? StreamsKt$$ExternalSyntheticApiModelOutline0.m1875m((Object) exception) : null;
        if (completionExceptionM1875m != null && (cause = completionExceptionM1875m.getCause()) != null) {
            exception = cause;
        }
        Result.Companion companion2 = Result.INSTANCE;
        continuation.resumeWith(Result.m534constructorimpl(ResultKt.createFailure(exception)));
    }
}
