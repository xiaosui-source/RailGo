...
public final class DelayKt {
    ...
    */
    ...
    public static final Object m2069delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2070toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2070toDelayMillisLRDsOJo(long j) {
        boolean zM1955isPositiveimpl = Duration.m1955isPositiveimpl(j);
        if (zM1955isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m1939getInWholeMillisecondsimpl(Duration.m1957plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM1955isPositiveimpl) {
