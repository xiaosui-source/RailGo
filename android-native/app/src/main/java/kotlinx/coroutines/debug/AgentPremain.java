...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM534constructorimpl = Result.m534constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM534constructorimpl = Result.m534constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m540isFailureimpl(objM534constructorimpl) ? null : objM534constructorimpl);
