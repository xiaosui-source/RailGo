...
public final class AnimatorSet extends Animator {
    ...
    @Override // io.dcloud.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public AnimatorSet m426clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.m426clone();
        ...
        while (it.hasNext()) {
            Node next = it.next();
            Node nodeM427clone = next.m427clone();
            map.put(next, nodeM427clone);
            animatorSet.mNodes.add(nodeM427clone);
            animatorSet.mNodeMap.put(nodeM427clone.animation, nodeM427clone);
            ArrayList arrayList = null;
            nodeM427clone.dependencies = null;
            nodeM427clone.tmpDependencies = null;
            nodeM427clone.nodeDependents = null;
            nodeM427clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = nodeM427clone.animation.getListeners();
            if (listeners != null) {
    ...
    private static class Node implements Cloneable {
        ...
        public Node m427clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.m426clone();
                return node;
