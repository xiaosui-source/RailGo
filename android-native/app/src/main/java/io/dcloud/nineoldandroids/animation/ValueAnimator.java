...
public class ValueAnimator extends Animator {
    ...
    @Override // io.dcloud.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public ValueAnimator m426clone() {
        ValueAnimator valueAnimator = (ValueAnimator) super.m426clone();
        ArrayList<AnimatorUpdateListener> arrayList = this.mUpdateListeners;
        if (arrayList != null) {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder propertyValuesHolderM430clone = propertyValuesHolderArr[i2].m430clone();
                valueAnimator.mValues[i2] = propertyValuesHolderM430clone;
                valueAnimator.mValuesMap.put(propertyValuesHolderM430clone.getPropertyName(), propertyValuesHolderM430clone);
            }
        }
        return valueAnimator;
    }
