...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    /* JADX WARN: Removed duplicated region for block: B:24:0x0055 A[Catch: all -> 0x00a8, TRY_ENTER, TryCatch #1 {all -> 0x00a8, blocks: (B:24:0x0055, B:25:0x0059, B:27:0x005d, B:28:0x0079, B:34:0x0088, B:35:0x0089, B:37:0x008d, B:39:0x0098, B:42:0x00a2, B:43:0x00a7, B:29:0x007a, B:30:0x0084), top: B:52:0x0053, inners: #0 }] */
    /* JADX WARN: Removed duplicated region for block: B:25:0x0059 A[Catch: all -> 0x00a8, TryCatch #1 {all -> 0x00a8, blocks: (B:24:0x0055, B:25:0x0059, B:27:0x005d, B:28:0x0079, B:34:0x0088, B:35:0x0089, B:37:0x008d, B:39:0x0098, B:42:0x00a2, B:43:0x00a7, B:29:0x007a, B:30:0x0084), top: B:52:0x0053, inners: #0 }] */
    ...
    */
    boolean writeOneFrame() throws java.io.IOException {
        /*
            ...
            return r1
        L8:
            dc.squareup.okhttp3.internal.ws.WebSocketWriter r0 = r11.writer     // Catch: java.lang.Throwable -> Lad
            java.util.ArrayDeque<dc.squareup.okio.ByteString> r2 = r11.pongQueue     // Catch: java.lang.Throwable -> Lad
            java.lang.Object r2 = r2.poll()     // Catch: java.lang.Throwable -> Lad
            dc.squareup.okio.ByteString r2 = (dc.squareup.okio.ByteString) r2     // Catch: java.lang.Throwable -> Lad
            r3 = 0
            r4 = -1
            if (r2 != 0) goto L4f
            ...
            boolean r6 = r5 instanceof dc.squareup.okhttp3.internal.ws.RealWebSocket.Close     // Catch: java.lang.Throwable -> Lad
            if (r6 == 0) goto L47
            ...
            if (r1 == r4) goto L31
            dc.squareup.okhttp3.internal.ws.RealWebSocket$Streams r4 = r11.streams     // Catch: java.lang.Throwable -> Lad
        ...
        L31:
            ...
            dc.squareup.okhttp3.internal.ws.RealWebSocket$CancelRunnable r7 = new dc.squareup.okhttp3.internal.ws.RealWebSocket$CancelRunnable     // Catch: java.lang.Throwable -> Lad
            r7.<init>()     // Catch: java.lang.Throwable -> Lad
            r8 = r5
            dc.squareup.okhttp3.internal.ws.RealWebSocket$Close r8 = (dc.squareup.okhttp3.internal.ws.RealWebSocket.Close) r8     // Catch: java.lang.Throwable -> Lad
        ...
        L52:
            ...
            goto L9d
        L59:
            boolean r2 = r3 instanceof dc.squareup.okhttp3.internal.ws.RealWebSocket.Message     // Catch: java.lang.Throwable -> La8
            if (r2 == 0) goto L89
            r1 = r3
            dc.squareup.okhttp3.internal.ws.RealWebSocket$Message r1 = (dc.squareup.okhttp3.internal.ws.RealWebSocket.Message) r1     // Catch: java.lang.Throwable -> La8
            dc.squareup.okio.ByteString r1 = r1.data     // Catch: java.lang.Throwable -> La8
            dc.squareup.okhttp3.internal.ws.RealWebSocket$Message r3 = (dc.squareup.okhttp3.internal.ws.RealWebSocket.Message) r3     // Catch: java.lang.Throwable -> La8
            ...
            dc.squareup.okio.Sink r0 = r0.newMessageSink(r2, r5)     // Catch: java.lang.Throwable -> La8
            dc.squareup.okio.BufferedSink r0 = dc.squareup.okio.Okio.buffer(r0)     // Catch: java.lang.Throwable -> La8
        ...
        L89:
            boolean r2 = r3 instanceof dc.squareup.okhttp3.internal.ws.RealWebSocket.Close     // Catch: java.lang.Throwable -> La8
            if (r2 == 0) goto La2
            dc.squareup.okhttp3.internal.ws.RealWebSocket$Close r3 = (dc.squareup.okhttp3.internal.ws.RealWebSocket.Close) r3     // Catch: java.lang.Throwable -> La8
            int r2 = r3.code     // Catch: java.lang.Throwable -> La8
            dc.squareup.okio.ByteString r3 = r3.reason     // Catch: java.lang.Throwable -> La8
            r0.writeClose(r2, r3)     // Catch: java.lang.Throwable -> La8
            if (r4 == 0) goto L9d
            dc.squareup.okhttp3.WebSocketListener r0 = r11.listener     // Catch: java.lang.Throwable -> La8
            r0.onClosed(r11, r1, r6)     // Catch: java.lang.Throwable -> La8
        L9d:
            dc.squareup.okhttp3.internal.Util.closeQuietly(r4)
            r0 = 1
            return r0
        La2:
