...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final Buffer copyTo(OutputStream outputStream, long j, long j2) throws IOException {
        ...
        if (j2 != 0) {
            ...
            while (j4 > 0) {
                ...
                outputStream.write(segment2.data, (int) (segment2.pos + j3), iMin);
                j4 -= iMin;
    ...
    */
    ...
    public long indexOf(ByteString byteString, long j) throws IOException {
        ...
        long j7 = (buffer.size - size) + 1;
        Segment segment2 = segment;
        long j8 = j;
        while (j6 < j7) {
            byte[] bArr = segment2.data;
            long j9 = j3;
            int iMin = (int) Math.min(segment2.limit, (segment2.pos + j7) - j6);
            int i = (int) ((segment2.pos + j8) - j6);
            while (i < iMin) {
