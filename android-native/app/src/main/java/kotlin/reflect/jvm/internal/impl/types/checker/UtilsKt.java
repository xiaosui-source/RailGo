...
public final class UtilsKt {
    public static final KotlinType findCorrespondingSupertype(KotlinType subtype, KotlinType supertype, TypeCheckingProcedureCallbacks typeCheckingProcedureCallbacks) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            for (KotlinType kotlinType : constructor2.mo1829getSupertypes()) {
    ...
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        for (ClassifierDescriptor classifierDescriptorMo1828getDeclarationDescriptor = typeConstructor.mo1828getDeclarationDescriptor(); classifierDescriptorMo1828getDeclarationDescriptor != null; classifierDescriptorMo1828getDeclarationDescriptor = classifierDescriptorMo1828getDeclarationDescriptor.getContainingDeclaration()) {
            debugInfo$lambda$1$unaryPlus("fqName: " + DescriptorRenderer.FQ_NAMES_IN_TYPES.render(classifierDescriptorMo1828getDeclarationDescriptor), sb);
            debugInfo$lambda$1$unaryPlus("javaClass: " + classifierDescriptorMo1828getDeclarationDescriptor.getClass().getCanonicalName(), sb);
        }
        return sb.toString();
    }
