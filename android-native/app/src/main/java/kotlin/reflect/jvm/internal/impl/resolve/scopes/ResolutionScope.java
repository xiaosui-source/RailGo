...
public interface ResolutionScope {
    ...
    ClassifierDescriptor mo1830getContributedClassifier(Name name, LookupLocation lookupLocation);
    ...
    void mo1834recordLookup(Name name, LookupLocation lookupLocation);
