...
public final class InlineClassesUtilsKt {
    ...
    public static final boolean isInlineClassType(KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo1828getDeclarationDescriptor != null) {
            return isInlineClass(classifierDescriptorMo1828getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean isValueClassType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo1828getDeclarationDescriptor = kotlinType.getConstructor().mo1828getDeclarationDescriptor();
        if (classifierDescriptorMo1828getDeclarationDescriptor != null) {
            return isValueClass(classifierDescriptorMo1828getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean needsMfvcFlattening(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo1828getDeclarationDescriptor = kotlinType.getConstructor().mo1828getDeclarationDescriptor();
        return (classifierDescriptorMo1828getDeclarationDescriptor == null || !isMultiFieldValueClass(classifierDescriptorMo1828getDeclarationDescriptor) || SimpleClassicTypeSystemContext.INSTANCE.isNullableType(kotlinType)) ? false : true;
    }
