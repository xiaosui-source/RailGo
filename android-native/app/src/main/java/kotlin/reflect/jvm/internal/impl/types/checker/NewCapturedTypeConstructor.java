...
public final class NewCapturedTypeConstructor implements CapturedTypeConstructor {
    ...
    public List<UnwrappedType> mo1829getSupertypes() {
    ...
    public static final List refine$lambda$6$lambda$5(NewCapturedTypeConstructor newCapturedTypeConstructor, KotlinTypeRefiner kotlinTypeRefiner) {
        List<UnwrappedType> listMo1829getSupertypes = newCapturedTypeConstructor.mo1829getSupertypes();
        ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(listMo1829getSupertypes, 10));
        Iterator<T> it = listMo1829getSupertypes.iterator();
        while (it.hasNext()) {
