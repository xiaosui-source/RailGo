    ...
    private static final KotlinType buildStarProjectionTypeByTypeParameters(final List<? extends TypeConstructor> list, List<? extends KotlinType> list2, KotlinBuiltIns kotlinBuiltIns) {
        KotlinType kotlinTypeSubstitute = TypeSubstitutor.create(new TypeConstructorSubstitution() { // from class: kotlin.reflect.jvm.internal.impl.types.StarProjectionImplKt.buildStarProjectionTypeByTypeParameters.1
            ...
            public TypeProjection get(TypeConstructor key) {
                ...
                ClassifierDescriptor classifierDescriptorMo1828getDeclarationDescriptor = key.mo1828getDeclarationDescriptor();
                Intrinsics.checkNotNull(classifierDescriptorMo1828getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.TypeParameterDescriptor");
                return TypeUtils.makeStarProjection((TypeParameterDescriptor) classifierDescriptorMo1828getDeclarationDescriptor);
            }
