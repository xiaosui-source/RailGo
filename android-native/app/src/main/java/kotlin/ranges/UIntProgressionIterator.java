...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m625boximpl(m1770nextpVg5ArA());
    }
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        this.hasNext = z;
        this.step = UInt.m631constructorimpl(i3);
    ...
    public int m1770nextpVg5ArA() {
        ...
        this.next = UInt.m631constructorimpl(this.step + i);
        return i;
    }
}
