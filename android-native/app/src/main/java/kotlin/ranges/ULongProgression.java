...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1750getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM710constructorimpl = ((int) ULong.m710constructorimpl(j ^ ULong.m710constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM710constructorimpl2 = (iM710constructorimpl + ((int) ULong.m710constructorimpl(j2 ^ ULong.m710constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM710constructorimpl2 + ((int) (j3 ^ (j3 >>> 32)));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m756toStringimpl(this.first));
            sb.append(PdrUtil.FILE_PATH_ENTRY_BACK);
            sb.append((Object) ULong.m756toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1778fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
