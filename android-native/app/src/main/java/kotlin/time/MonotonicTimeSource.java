...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2042boximpl(m2036markNowz9LOYto());
    }
    ...
    public long m2036markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2045constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2035elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2034differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m2033adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2045constructorimpl(LongSaturatedMathKt.m2031saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
